Myapp::Application.routes.draw do
  ...
  get 'pago_alquilers/new_transferencia' => 'pago_alquilers#mf_new_transferencia', as: :registrar_pago_transferencia
  post '/pago_alquilers/create' =>  'pago_alquilers#create'
  get 'pago_alquilers/new_cheque_efectivo' => 'pago_alquilers#mf_new_cheque_efectivo', as: :registrar_pago_cheque_efectivo
  ...
  get 'pago_alquilers/facturas_tiendas/:id' => 'pago_alquilers#mf_facturas_tiendas'
  get 'pago_alquilers/new_cheque_efectivo/:id' => 'pago_alquilers#mf_new_cheque_efectivo'
