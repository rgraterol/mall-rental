...
# ROLES DE MALL
administrador_mall = Role.create!(name: 'Administrador Mall', permissions: Permission.where(name: ['manage'], subject_class: ['ActividadEconomica', 'NivelMall', 'CalendarioNoLaborable', 'CambioMoneda', 'Local', 'Arrendatario', 'Tienda', 'ContratoAlquiler', 'UserTienda', 'PagoAlquiler']), role_type: Role.role_types[:cliente_mall], tipo_servicio: mall )
...
propietario_mall = Role.create!(name: 'Propietario Mall', permissions: Permission.where(name: ['manage'], subject_class: ['PagoAlquiler']), role_type: Role.role_types[:cliente_mall], tipo_servicio: mall)
gestor_alquileres = Role.create!(name: 'Gestor de Alquileres Mall', role_type: Role.role_types[:cliente_mall], tipo_servicio: mall)
gerente_tienda = Role.create!(name: 'Gerente de Tienda Mall', permissions: Permission.where(name: ['index'], subject_class: ['Venta']) ,role_type: Role.role_types[:cliente_tienda], tipo_servicio: mall)
gerente_tienda.update(permissions: Permission.where(name: 'manage', subject_class: 'PagoAlquiler'))
administrador_tienda = Role.create!(name: 'Administrador de Tienda Mall', permissions: Permission.where(name: ['index'], subject_class: ['Venta']), role_type: Role.role_types[:cliente_tienda], tipo_servicio: mall)
...
propietario_mall_rental = Role.create!(name: 'Propietario Mall Rental', permissions: Permission.where(name: ['manage'], subject_class: ['PagoAlquiler']), role_type: Role.role_types[:cliente_mall], tipo_servicio: mall_rental)
...
gerente_tienda_rental = Role.create!(name: 'Gerente de Tienda Mall Rental', permissions: Permission.where(name: ['index'], subject_class: ['Venta']) ,role_type: Role.role_types[:cliente_tienda], tipo_servicio: mall_rental)
gerente_tienda_rental.update(permissions: Permission.where(name: 'manage', subject_class: 'PagoAlquiler'))
administrador_tienda_rental = Role.create!(name: 'Administrador de Tienda Mall Rental', permissions: Permission.where(name: ['index'], subject_class: ['Venta']), role_type: Role.role_types[:cliente_tienda], tipo_servicio: mall_rental)
administrador_tienda_rental.update(permissions: Permission.where(name: 'manage', subject_class: 'PagoAlquiler'))
...
propietario_mall_condominio = Role.create!(name: 'Propietario Mall Condominio', permissions: Permission.where(name: ['manage'], subject_class: ['PagoAlquiler']), role_type: Role.role_types[:cliente_mall], tipo_servicio: mall_condominio)
